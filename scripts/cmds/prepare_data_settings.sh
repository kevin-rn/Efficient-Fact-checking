...
echo -e "original"
python3 data_processing.py --setting=$wikifolder-original --pre_compute_embed --store_original
python3 data_processing.py --setting=$wikifolder-original --first_para_only --pre_compute_embed --store_original
