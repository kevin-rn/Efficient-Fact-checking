...
from WikiExtractor import (NextFile, fullyQualifiedTemplateTitle, lcfirst,
                           normalizeTitle, splitParts, ucfirst, unescape)
...
class TestSplitParts(unittest.TestCase):
    ...
    def test_complex(self):
        self.assertEqual(
            splitParts('{{#if: {{{1}}} | {{lc:{{{1}}} | "parameter missing"}}'),
